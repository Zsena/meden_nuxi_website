...
<template>
  <main class="">
    ...
    <section class="py-10 px-4">
      <div
        class="container mx-auto flex flex-col items-center relative h-[650vw] xs:h-[465vw] sm:h-[255vh] md:h-[355vh] lg:h-full">

        <article class="absolute lg:right-[1rem]">
          <h2 class="h2 md:pt-10">Szolgáltatásaink</h2>
          <h3 class="absolute top-[3rem] md:top-[6rem] left-1/2 -translate-x-1/2 whitespace-nowrap lg:left-[10rem]">
            Tervezés, kivitelezés</h3>
          <h3 class="absolute top-[4.5rem] md:top-[8rem] left-1/2 -translate-x-1/2 whitespace-nowrap lg:left-[13rem]">
            Beüzemelés, felújítás</h3>
          <h3 class="absolute top-[6rem] md:top-[10rem] left-1/2 -translate-x-1/2 whitespace-nowrap lg:left-[16rem]">
            Karbantartás, csere</h3>
        </article>

        <div
          class="card-container flex flex-1 flex-col items-center lg:flex-row lg:justify-center lg:gap-[8rem] lg:ml-20  xl:gap-[20rem] ">
          <div
            ...
            <div
              ...
              <div class="relative">
                ...
                <NuxtImg src="../public/img/3.svg"
                  class="absolute left-1/2 -translate-x-1/2 -top-[9rem] lg:translate-x-1/2 lg:-left-[11.5rem] lg:-top-[5rem]" />
              </div>
            </div>
          </div>
          <div class="card-col flex flex-1 flex-col  justify-start items-center gap-y-32 mt-[30rem] ">
            <div
              ...
              <div class="relative">
                ...
                <NuxtImg src="../public/img/2.svg"
                  class="absolute left-1/2 -translate-x-1/2 -top-[9rem] lg:translate-x-1/2 lg:-left-[12rem] lg:-top-[5rem]" />
              </div>
            </div>
            <div
